...
public class morefillinmethods
{
	public static void main( String[] args )
	{
		...
		lo = 1;
		hi = 10;
		val1=superrand(lo,hi,val1);
		System.out.println("First: " + val1 );
		val2=superrand(lo,hi,val2);  // this time, put hi first
		...
		result=project_grade(a,b,c,d,e,f,result);
	...
	public static int superrand(int a,int b, int c)
	// Parameters are:
	//	int a;
	//	int b;
	{
	...
	public static int project_grade(int p1, int p2, int p3, int p4, int p5, int p6, int overall_grade)
	// Parameters are:
